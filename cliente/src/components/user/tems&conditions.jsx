    ...
    return (
      <div>
        ...
        <p>
          ...
          Conditions") carefully before using the http://www.mytinerary.com
          website (the "Service") operated by MYtinerary ("us", "we", or "our").
        </p>
        <p>
        ...
        <p>
          ...
          access the Service. The Terms and Conditions agreement for MYtinerary
        ...
        <p>
          ...
          that are not owned or controlled by MYtinerary.
        </p>
        <p>
          MYtinerary has no control over, and assumes no responsibility for, the
          content, privacy policies, or practices of any third party web sites
          or services. You further acknowledge and agree that MYtinerary shall
