...
class Favorite extends React.Component {
  ...
  //   await this.props.myFavAction(this.props.loginReducer.currentUser.itinerariesFav);
  //   this.setState({
  //     currentUser: this.props.loginReducer.currentUser,
  //     isConected: this.props.loginReducer.isConected,
  //     itFav: this.props.myFavoriteReducer.myFav,
  //     isFetching: this.props.myFavoriteReducer.isFetching,
  //   });
  // }
